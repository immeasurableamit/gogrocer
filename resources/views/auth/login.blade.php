...
<body class="layout-login-centered-boxed">
    <div class="layout-login-centered-boxed__form card">
        <div class="d-flex flex-column justify-content-center align-items-center mt-2 mb-5 navbar-light">
            <a class="navbar-brand flex-column mb-2 align-items-center mr-0" style="min-width: 0">
                <span class="text-primary mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" style="width:20px;" viewBox="0 0 40 40">
                        <path
            ...
            <p class="m-0">Login to access your GOGO Account </p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" novalidate>
            ...
            @enderror
            <div class="form-group">
                <button class="btn btn-block btn-primary ladda-button" data-style="expand-right" type="submit">Login</button>
            </div>

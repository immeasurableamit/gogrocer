            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="file" name="banner" class="form-control" onchange="document.getElementById('banner').src = window.URL.createObjectURL(this.files[0])">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{('Icon')}} <small>({{ ('32x32') }})</small></label>
                         <div class="col-md-9">
                            <input type="file" name="icon" class="form-control" onchange="document.getElementById('banner').src = window.URL.createObjectURL(this.files[0])">
